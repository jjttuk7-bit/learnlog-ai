...
import { Home, PenLine, Brain, BarChart3, Swords, User, Network, BookOpen, Users, NotebookPen, Trash2, GraduationCap, BookA } from "lucide-react";

const navItems = [
  { href: "/", label: "홈", icon: Home },
  { href: "/capture", label: "캡처", icon: PenLine },
  { href: "/diary", label: "일기", icon: NotebookPen },
  { href: "/tutor", label: "튜터", icon: GraduationCap },
  { href: "/glossary", label: "용어", icon: BookA },
